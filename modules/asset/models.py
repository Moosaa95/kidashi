...
class Asset(ModelMixin):
    ...
    vendor = models.ForeignKey("vendor.Vendor", on_delete=models.CASCADE, related_name="requested_assets")
    # Foreign key to woman who requested the asset
    woman = models.ForeignKey("woman.Woman", on_delete=models.CASCADE, related_name="assets_requested")
